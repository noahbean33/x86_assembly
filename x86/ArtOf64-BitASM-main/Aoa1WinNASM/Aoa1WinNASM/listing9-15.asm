...
true        equ     1
            ...
            section .const
ttlStr      db      "Listing 9-15", 0
fmtStr1     db      "strtoh: String='%s' "
            db      "value=%I64x", nl, 0
           
fmtStr2     db      "Error, RAX=%I64x, str='%s'", nl, 0 
fmtStr3     db      "Error, expected overflow: RAX=%I64x, "
            db      "str='%s'", nl, 0
             
fmtStr4     db      "Error, expected bad char: RAX=%I64x, "
            db      "str='%s'", nl, 0 

hexStr      db      "1234567890abcdef", 0
hexStrOVFL  db      "1234567890abcdef0", 0
hexStrBAD   db      "x123", 0

...
#
				.text
				shldl	$constant, reg32, dVar(%rip)
				shldl	cl, reg32, dVar(%rip)
				shldl	$constant, reg32, reg32
				shldl	cl, reg32, reg32
				
				shldq	$constant, reg64, qVar(%rip)
				shldq	cl, reg64, qVar(%rip)
				shldq	$constant, reg64, reg64
				shldq	cl, reg64, reg64
				
				shrdl	$constant, reg32, dVar(%rip)
				shrdl	cl, reg32, dVar(%rip)
				shrdl	$constant, reg32, reg32
				shrdl	cl, reg32, reg32
				
				shrdq	$constant, reg64, qVar(%rip)
				shrdq	cl, reg64, qVar(%rip)

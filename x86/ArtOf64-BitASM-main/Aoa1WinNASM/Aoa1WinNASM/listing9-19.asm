...
true        equ     1
            ...
            section .const
ttlStr      db      "Listing 9-19", 0
fmtStr1     db      "strToR10: str='%s', value=%e", nl, 0
           
fStr1a      db      "1.234e56",0
fStr1b      db      "-1.234e56",0
fStr1c      db      "1.234e-56",0
fStr1d      db      "-1.234e-56",0
fStr2a      db      "1.23",0
fStr2b      db      "-1.23",0
fStr3a      db      "1",0
fStr3b      db      "-1",0
fStr4a      db      "0.1",0
fStr4b      db      "-0.1",0
fStr4c      db      "0000000.1",0
fStr4d      db      "-0000000.1",0
fStr4e      db      "0.1000000",0
fStr4f      db      "-0.1000000",0
fStr4g      db      "0.0000001",0
fStr4h      db      "-0.0000001",0
fStr4i      db      ".1",0
fStr4j      db      "-.1",0

values      dq      fStr1a, fStr1b, fStr1c, fStr1d
            dq      fStr2a, fStr2b
            dq      fStr3a, fStr3b

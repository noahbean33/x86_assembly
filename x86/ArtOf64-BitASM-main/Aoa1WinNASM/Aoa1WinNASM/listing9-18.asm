...
true        equ     1
            ...
            section .const
ttlStr      db      "Listing 9-18", 0
fmtStr1     db      "strtou128: String='%s' value=%I64x%I64x", nl, 0
           
oStr      	db      "340282366920938463463374607431768211455", 0
ten	dq	10
...
convErr	db  	"Conversion error: %zd", nl, 0

...
tab         equ     9
            ...
            section .const
ttlStr      db      "Listing 9-10", 0
fmtStr1     db      "f10ToStr: value='%s'", nl, 0
fmtStr2     db      "fpError: code=%I64d", nl, 0
fmtStr3     db      "e10ToStr: value='%s'", nl, 0

r10_1       dt      1.2345678901234567
r10_2       dt      0.0000000000000001
r10_3       dt      12345678901234567.0
r10_4       dt      1234567890.1234567
r10_5       dt      994999999999999999.0

e10_1       dt      1.2345678901234567e123
e10_2       dt      1.2345678901234567e-123
e10_3       dt      1.2345678901234567e1
e10_4       dt      1.2345678901234567e-1
e10_5       dt      1.2345678901234567e10
e10_6       dt      1.2345678901234567e-10
e10_7       dt      1.2345678901234567e100
e10_8       dt      1.2345678901234567e-100
e10_9       dt      1.2345678901234567e1000
e10_0       dt      1.2345678901234567e-1000

            section .data
r10str_1    db      32 dup (0)
...
fillZeros:  mov     byte [rdi+rcx*1-1], '0'
            dec     ecx
            jnz     fillZeros
...
; remaining digit positions.
            ...
            mov     byte[digits+rbx*1 ], '0'+10     ; Force to zero

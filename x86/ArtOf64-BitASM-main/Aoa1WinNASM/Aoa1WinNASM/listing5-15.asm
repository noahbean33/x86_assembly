...
numElements equ	10
            ...
            section	.const
ttlStr      db    	"Listing 5-15", 0
fmtStr1     db    	"Data before sorting: ", nl, 0
fmtStr2     db    	"%d "   ;Use nl and 0 from fmtStr3
fmtStr3     db    	nl, 0
fmtStr4     db    	"Data after sorting: ", nl, 0

        
            section	.data
theArray    dd   	1,10,2,9,3,8,4,7,5,6

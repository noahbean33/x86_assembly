...
# negate the input if the flag contains true.
            ...
            cmp     tooBig(rip), rax    #number is too big
            ja      overflow2
            neg     rax
...
# Test signed conversions:
            ...
            lea     fmtStr2(rip), rdi
            lea     OFivalue(rip), rsi
            mov     rax, rdx
            mov     $0, al
            call    _printf
            
 
            lea     OFivalue2(rip), rdi
            call    strtoi
            jnc     UnexpectedError
            test    rax, rax        #Non-zero for overflow
            jz      UnexpectedError

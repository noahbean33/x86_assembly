...
# documentation for the "ld" program; it has options
...
#
# Just like MASM, as will allocate variables within
...
# as doesn't have a .const section for holding
...
# as doesn't have a ".data?" segment like MASM. However,
...
#----------------------------------------------------
#
# The as ".balign" directive.
#
# The as ".balign" directive allows you to align
...
#----------------------------------------------------
#
# Labels in a as program have an address associated
...
#	Direct					Direct(%rip)			Access simple variable in memory
...
# The following are not possible in macOS because
# it doesn't support the concept of "LARGEADDRESSAWARE:no" (Windows) or
# -no-pie (Linux):
#				
#				mov		bVar(,rax), al
#				mov		bVar(,rax,1), al

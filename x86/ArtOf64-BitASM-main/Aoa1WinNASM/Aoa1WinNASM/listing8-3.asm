...
nl          equ     10
            ...
            section .const
ttlStr      db      "Listing 8-3", 0
fmtStr1     db      "quotient  = "
            db      "%08x_%08x_%08x_%08x"
            db      nl, 0
            
fmtStr2     db      "remainder = "
            db      "%08x_%08x_%08x_%08x"
            db      nl, 0
            
fmtStr3     db      "quotient (2)  = "
            db      "%08x_%08x_%08x_%08x"
            db      nl, 0
...
op1         dq      8888666644440000h, 2222eeeeccccaaaah            
op2         dq      2, 0
op3         dq      4444333322220000h, 1111777766665555h
result      dq      0, 0
remain      dq      0, 0
...
repeatLp:   shl     qword dividend(0), 1  ;256-bit extended
...
; Print the results:
            ...
            lea     rcx, [fmtStr1]
            mov     edx, dword result[12]
            mov     r8d, dword result[8]
            mov     r9d, dword result[4]
            ...
            lea     rcx, [fmtStr2]
            mov     edx, dword remain[12]
            mov     r8d, dword remain[8]
            mov     r9d, dword remain[4]
            mov     eax, dword remain[0]
            mov     [rsp+32], rax
            call    printf

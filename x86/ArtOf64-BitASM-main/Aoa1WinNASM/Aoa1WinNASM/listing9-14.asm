...
true        equ     1
            ...
            section .const
ttlStr      db      "Listing 9-14", 0
fmtStr1     db      "strtou: String='%s'", nl
            db      "    value=%I64u", nl, 0
            
fmtStr2     db      "Overflow: String='%s'", nl
            db      "    value=%I64x", nl, 0
            
fmtStr3     db      "strtoi: String='%s'", nl
            db      "    value=%I64i",nl, 0
                    
unexError   db      "Unexpected error in program", nl, 0
            
value1      db      "  1", 0
value2      db      "12 ", 0
value3      db      " 123 ", 0
value4      db      "1234", 0
value5      db      "1234567890123456789", 0
value6      db      "18446744073709551615", 0
OFvalue     db      "18446744073709551616", 0
OFvalue2    db      "999999999999999999999", 0
            
ivalue1     db      "  -1", 0
ivalue2     db      "-12 ", 0
ivalue3     db      " -123 ", 0
ivalue4     db      "-1234", 0
ivalue5     db      "-1234567890123456789", 0
ivalue6     db      "-9223372036854775807", 0
OFivalue    db      "-9223372036854775808", 0
OFivalue2   db      "-999999999999999999999", 0
...
; negate the input if the flag contains true.
            ...
            ja      overflow2
            neg     rax
itsPosOr0:  add     rsp, 24 ;Success, so don't restore RDI
            clc             ;Return success in carry flag
            ret

; If we have an error, we need to restore RDI from the stack

overflow2:  mov     rax, -1 ;Indicate overflow      
hadError:   add     rsp, 16 ;Remove locals
            pop     rdi
            stc             ;Return error in carry flag
            ret 
            
tooBig      dq      7fffffffffffffffh
